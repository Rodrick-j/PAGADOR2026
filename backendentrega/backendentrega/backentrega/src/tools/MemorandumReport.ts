...
export class MemorandumReport {
    static async creaPDF(data: any, template: string, res: Response): Promise<any> {
        ...
        <tr>
        <td width="33.33%" style="padding:4px;font-size:8px;border-top:solid 0px lightgrey;text-align:left;">Generado por:&nbsp;&nbsp;<span class="font-thin">${data.info.usuario_a_cargo}</span></td>
