...
import { AreaFormModel } from './AreaFormDialog';
...
const AreaDialog = ({ open, onComplete, formModel }: Props) => {
            ...
            <DialogTitle id="form-dialog-title">
                <Box display="flex" alignItems="center" justifyContent="space-between">
                    <Box alignItems="center" display="flex" overflow="hidden">
                        ...
                        <Typography noWrap>Detalle de Area</Typography>
                    </Box>
                    <Box>
                ...
                <Box sx={{ flexGrow: 1, m: 2 }}>
                    <Grid container spacing={1}>
                        ...
                        <Grid item xs={12} md={9}>
                            <Typography variant="body1" sx={{ mx: 2 }}>{formModel?.nombre}</Typography>
                        </Grid>             
                    </Grid>
                </Box>
            </DialogContent>
