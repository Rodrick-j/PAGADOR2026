...
import { MemorandumrrhhReporteFormModel } from './MemorandumrrhhReporteFormDialog';
...
const MemorandumrrhhReporteDialog = ({ open, onComplete, formModel }: Props) => {
            ...
            <DialogTitle id="form-dialog-title">
                <Box display="flex" alignItems="center" justifyContent="space-between">
                    <Box alignItems="center" display="flex" overflow="hidden">
                        ...
                        <Typography noWrap>Reportes Memorandum RR.HH.</Typography>
                ...
                <Box sx={{ flexGrow: 1, m: 2 }}>
                    <Grid container spacing={1}>
                        ...
                        <Grid item xs={12} md={9}>
                            ...
                            <Typography variant="body1" sx={{ mx: 2 }}>{formModel?.cod_depart_memo}</Typography>
                        </Grid>
                    </Grid>
                </Box>
            </DialogContent>
...
export default MemorandumrrhhReporteDialog;
