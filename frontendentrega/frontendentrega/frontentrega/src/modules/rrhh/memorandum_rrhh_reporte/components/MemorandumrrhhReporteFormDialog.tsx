...
import { MemorandumrrhhModuleService } from 'modules/rrhh/memorandum_rrhh/MemorandumrrhhModuleService';

export type MemorandumrrhhReporteFormModel = {
...
export type MemorandumrrhhReporteFormModelDetalle = {
    id?                    : string;
    cod_depart_memo        : string;
    fecha_inicio_viaje     : Date;
    fecha_fin_viaje        : Date;
...
export type MemorandumrrhhReporteFormModelDetalle2 = {
    id?                    : string;
    nombre_usuario : string;
    ci: string;
    cargo_usuario : string
...
type Props = {
    open: boolean;
    formModel?: MemorandumrrhhReporteFormModel;
    formModel2?:MemorandumrrhhReporteFormModelDetalle;
    onComplete: () => void;
};

export const MemorandumrrhhReporteFormDialog = ({ open, formModel,formModel2, onComplete }: Props): ReactElement => {
   ...
   //genracion de listas cargo, usuarios
     ...
     const [aperturaUsuarios, setAperturaUsuarios] = useState<{id: string; nombre: string;id_usuario:string}[]>([]);
...
const citesOptions =   (formValue: FormValue): SelectOption[] => {
 ...
 const [formValues, setFormValues] = useState<MemorandumrrhhReporteFormModel>(() => ({
    ...{
        nombre_usuario      : '',
        ci                  : '',
        cargo_usuario       : '',
...
//datos originales memorandum
   ...
   useEffect(() => {
    ...
    const formLayout: FormGroup<MemorandumrrhhReporteFormModel>[] = [
        {
    ...
    const handleSubmit = async (formData: FormValue) => {
        const result = await MemorandumrrhhModuleService.createOrUpdateMemorandum(formData as unknown as MemorandumrrhhReporteFormModel);
    ...
    const zeroValues: MemorandumrrhhReporteFormModel = {
