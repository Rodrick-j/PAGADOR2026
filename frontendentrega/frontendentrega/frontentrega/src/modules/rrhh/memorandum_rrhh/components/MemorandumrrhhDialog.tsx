...
import { MemorandumrrhhFormModel } from './MemorandumrrhhFormDialog';
...
const MemorandumrrhhDialog = ({ open, onComplete, formModel }: Props) => {
...
export default MemorandumrrhhDialog;
