...
import { DestinoFormModel } from './DestinoFormDialog';
...
const DestinoDialog = ({ open, onComplete, formModel }: Props) => {
            ...
            <DialogContent dividers style={{ padding: 0 }}>
                <Box sx={{ flexGrow: 1, m: 2 }}>
                    <Grid container spacing={1}>
                        ...
                        <Grid item xs={12} md={9}>
                            <Typography variant="body1">{formModel?.distancia}</Typography>
                        </Grid>
                        <Grid item xs={12} md={3}>
                            <b>Litros:</b>
                        </Grid>
                        <Grid item xs={12} md={9}>
                            <Typography variant="body1">{formModel?.litros}</Typography>
                        </Grid>            
                    </Grid>
                </Box>
            </DialogContent>
