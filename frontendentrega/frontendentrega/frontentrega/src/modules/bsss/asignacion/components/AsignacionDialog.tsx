...
import { AsignacionFormModel } from './AsignacionFormDialog';
...
const AsignacionDialog = ({ open, onComplete, formModel }: Props) => {
            ...
            <DialogTitle id="form-dialog-title">
                <Box display="flex" alignItems="center" justifyContent="space-between">
                    <Box alignItems="center" display="flex" overflow="hidden">
                        ...
                        <Typography noWrap>Detalle de Asignacion</Typography>
                    </Box>
                    <Box>
