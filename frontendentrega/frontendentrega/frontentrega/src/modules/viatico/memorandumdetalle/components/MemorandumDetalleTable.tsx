...
import { ROLES_EDICION } from 'constants/enums';
...
export const DetalleTableComponent = (props: Props,ref: React.Ref<MemorandumDetalleTableRefProps>): ReactElement => {
    ...
    let tableHeaders: TableHeader<MemorandumDetalleTableModel>[] = [
        ...
        { id: 'num_placa', label: 'Tipo Vehiculo', align: 'center'},
    ...
    function renderModificacionStatus(data: MemorandumDetalleTableModel): ReactElement {
        const color = 'white';
...
export const MemorandumDetalleTable = forwardRef(DetalleTableComponent);
