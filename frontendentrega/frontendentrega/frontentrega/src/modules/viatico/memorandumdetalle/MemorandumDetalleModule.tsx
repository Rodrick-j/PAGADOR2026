...
import {  MemorandumDetalleDestinoFormDialog, MemorandumDetalleDestinoFormModel } from './components/MemorandumDetalleFormDialog';
...
export const MemorandumDetalleModule = (): ReactElement => {
    ...
    const [formModel, setFormModel] = useState<MemorandumDetalleDestinoFormModel>();
                ...
                if (newFormModel !== null)
                    setMemorandumData({
                                    ...
                                    // cargo_jefe_unidad      : string;
                                        ...
                                        justificacion      : newFormModel.justificacion,
    ...
    return (
        <>
            <MemorandumDetalleDestinoFormDialog
                open={formOpen}
                formModel={formModel}
                onComplete={() => {
                    setFormOpen(false);
