...
import { AperturaViaticoFormModel } from './AperturaViaticoFormDialog';
...
const AperturaViaticoDialog = ({ open, onComplete, formModel }: Props) => {
            ...
            <DialogTitle id="form-dialog-title">
                <Box display="flex" alignItems="center" justifyContent="space-between">
                    <Box alignItems="center" display="flex" overflow="hidden">
                        ...
                        <Typography noWrap>Detalle de Apertura Viatico</Typography>
                    </Box>
                    <Box>
...
export default AperturaViaticoDialog;
