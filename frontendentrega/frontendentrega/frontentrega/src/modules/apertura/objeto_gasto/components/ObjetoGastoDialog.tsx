...
import { ObjetoGastoFormModel } from './ObjetoGastoFormDialog';
...
const ObjetoGastoDialog = ({ open, onComplete, formModel }: Props) => {
                ...
                <Box sx={{ flexGrow: 1, m: 2 }}>
                    <Grid container spacing={1}>
                        ...
                        <Grid item xs={12} md={9}>
                            ...
                            <Typography variant="body1" sx={{ mx: 2 }}>{formModel?.objeto}</Typography>  
                        </Grid>
                    </Grid>
                    ...
                    <Table>
                        <TableBody>
                            <TableRow>
                             ...
                             <TableRow>
                                <TableCell  style={{ fontWeight: "bold" }}>OBSERVACION:</TableCell>
                                <TableCell>{formModel?.observacion}</TableCell>                       
                            </TableRow>
                             <TableRow>
                                <TableCell  style={{ fontWeight: "bold" }}>ESTADO:</TableCell>
                                <TableCell>{formModel?.estado}</TableCell>                       
                            </TableRow>                            
...
export default ObjetoGastoDialog;
