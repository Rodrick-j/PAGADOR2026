...
import { HistorialAperturaFormModel } from './HistorialAperturaFormDialog';
...
const HistorialAperturaDialog = ({ open, onComplete, formModel }: Props) => {
...
export default HistorialAperturaDialog;
