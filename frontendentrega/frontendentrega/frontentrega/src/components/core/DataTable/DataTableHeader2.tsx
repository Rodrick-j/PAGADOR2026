...
import { useTheme, TableCell, TableSortLabel, TableHead, TableRow, Box, Checkbox } from '@mui/material';
import { DataTableHeaderProps2, TableHeader, MyTableModel } from './Types';
...
export const DataTableHeader2 = ({ headers, updateParams, numSelected, rowCount, onOrderChange, onSelectAllClick }: DataTableHeaderProps2): ReactElement => {
    ...
    return (
        <TableHead>
            <TableRow>
                ...
                {headers.map((column, columnIndex) => renderTableCell(column, columnIndex))}
            </TableRow>
        </TableHead>
    );
};
